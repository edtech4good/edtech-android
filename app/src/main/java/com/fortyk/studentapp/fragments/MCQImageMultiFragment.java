...
import com.fortyk.studentapp.adapters.MultiImageAdapter;
...
public class MCQImageMultiFragment extends Fragment implements OptionItemClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (title != null && !title.isEmpty()) {
            ...
            question_title.setText("Listen and choose the right pictures.");
        }

        Collections.shuffle(questionModelList);
        adapter = new MultiImageAdapter(getActivity(), questionModelList, this);
