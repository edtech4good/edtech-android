...
public class AssociateModel implements Parcelable {
    ...
    public AssociateModel(String questionoptionid, String questionoptiontext,
                          int questionoptionsequence, boolean questionoptioniscorrect,
                          QuestionOptionfile questionoptionfile, QuestionAssociate questionassociate,
                          boolean selectediscorrect, boolean isSelected) {
    ...
    protected AssociateModel(Parcel in) {
    ...
    public static final Creator<AssociateModel> CREATOR = new Creator<AssociateModel>() {
        @Override
        public AssociateModel createFromParcel(Parcel in) {
            return new AssociateModel(in);
        }

        @Override
        public AssociateModel[] newArray(int size) {
            return new AssociateModel[size];
        }
    };
