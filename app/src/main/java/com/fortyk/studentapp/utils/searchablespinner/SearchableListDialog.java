package com.fortyk.studentapp.utils.searchablespinner;
...
//c9HyTRVCjmXDkyeRehwx
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setOnShowListener(_dialog -> {
            ...
            b.setOnClickListener(view -> {
                _onClickListener.onClick(_dialog, AlertDialog.BUTTON_POSITIVE);
            });
        });
        return dialog;
    }
    ...
    public String getSearchText() {
        return this._searchView.getQuery().toString();
    }
